...
| X-61 | `start.bat` закрывает окно вместе с адресами и ошибкой | infra | In Progress | `fix/X-61-bat-pause` |
| X-62 | Экран «Счета» говорит про коллектор неправду | frontend | In Progress | `fix/X-62-collector-block-texts` |
