...
| `apps/web` | React 19 + TypeScript: роутер, экран входа, настройки, тёмная тема, типы из OpenAPI. Счета (`S1-11`) и Журнал — список с фильтрами и карточка позиции (`S2-06`, `S2-07`) — работают. Дашборд и Календарь — заглушки |
