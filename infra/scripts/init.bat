...
:done
rem Без паузы окно закроется вместе с предупреждением про MASTER_KEY — а это ключ
rem шифрования всей установки, и человек обязан прочитать про него до того, как закроет
