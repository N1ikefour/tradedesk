 ...
 *
 * Раскладка подчинена одному числу из DoD: рефлексия заполняется за 30 секунд. Поэтому
 * всё, что выбирается, выбирается одним нажатием и лежит на виду, а не в выпадающих
 * списках; свободный текст — единственное поле, где надо печатать.
 *
