...
Ручные сделки — `S2-03`, вложения — `S2-04`. Календарь (`GET /journal/calendar`, `S2-05`)
остался на своём пути из SPEC.md 5.4, но объявлен доменом аналитики: он считает то же и теми
же правилами дня и периода, что и сводка.
