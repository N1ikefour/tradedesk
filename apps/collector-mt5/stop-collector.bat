...
rem задача Планировщика, менеджер и процессы счетов силой. Разницу видно на карточках
rem счетов: своим выходом менеджер говорит «остановлен», принудительным — не говорит
rem ничего, и через пять минут там появляется «коллектор не на связи». Что именно
rem получилось, скрипт печатает словами.
rem
