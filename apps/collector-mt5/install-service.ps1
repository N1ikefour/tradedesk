...
# Процессов счетов больше нет (X-66 снял X-57), но под задачей Планировщика их всё равно
# два — cmd.exe и python.exe, — поэтому Stop-Collector гасит и дерево задачи, и процесс.
# На карточках счетов разницы между исходами по-прежнему нет никакой.
